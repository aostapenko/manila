    ...
    def wrapped_func(self, *args, **kwargs):
        ...
        if not share_network_id:
            for arg in args:
                ...
                raise exception.ManilaException(_('Could not get share '
                                                  'network id'))
...
class ServiceInstanceManager(object):
    ...
    def __init__(self, db, _helpers, *args, **kwargs):
        ...
        while attempts:
            ...
            raise exception.ManilaException(_('Can not receive '
                                              'service tenant id.'))
    ...
    def get_service_instance(self, context, share_network_id, create=True):
        ...
        if self._ensure_server(context, server, update=True):
            ...
            if len(servers) == 1:
                ...
                raise exception.ManilaException(_('Error. Ambiguous service '
                                                  'instances.'))
    ...
    def _get_service_image(self, context):
        ...
        if len(images) == 1:
            ...
            raise exception.ManilaException(_('No appropriate '
                                              'image was found.'))
        else:
    ...
    def _get_service_subnet(self, share_network_id):
        ...
        if len(service_subnets) == 1:
            ...
            raise exception.ManilaException(_('Ambiguous service subnets.'))
