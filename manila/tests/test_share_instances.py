...
class InstanceManagerTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self._db = mock.Mock()
        self.stubs.Set(instance, 'neutron', mock.Mock())
        self._driver = instance.InstanceManager(self._db, {})
    ...
    def testget_service_instance_name(self):
        result = self._driver.get_service_instance_name(self.share)
    ...
    def testget_service_instance(self):
        ...
        result = self._driver.get_service_instance(self._context, self.share)
    ...
    def testget_service_instance_existed_in_memory(self):
        fake_server = fake_compute.FakeServer()
    ...
    def testget_service_instance_existed_in_memory_non_active(self):
    ...
    def testget_service_instance_existed(self):
        fake_server = fake_compute.FakeServer()
        self.stubs.Set(self._driver, '_ensure_or_delete_server',
                       mock.Mock(return_value=True))
        self.stubs.Set(self._driver, '_get_server_ip',
    ...
    def test_setup_service_port(self):
        ...
        self._driver.neutron_api.create_port.assert_called_once_with(
                                    ...
                                    device_owner='manila:instance_driver',
                                    host_id='fake_host'
                                    )
